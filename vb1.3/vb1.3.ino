...
//ch1mera logo
    ...
    byte eye_L[] = {B01110, B10001, B10001, B11111, B11001, B10011, B11111, B00000};
    byte eye_O[] = {B00110, B01001, B00001, B11111, B11001, B10011, B11111 ,B00000};

//Others
    int loop_cnt=0;

String version = "vb1.3";
...
void setup() {
    ...
    lcd.createChar(2, eye_L);
    lcd.createChar(3, eye_O);
    loading(1);
        ...
        if (enter == 1 ){
            ...
            //check eyeControl
                if (lock == false){
                    ...
                    lcd.clear();
                    statusBar();
                    lcd.setCursor(0,1); lcd.print("Bloqueado");
                    delay(1000);
                    home();
                } else if (lock == true) {
                    lock = false;
                    ...
                    lcd.clear();
                    statusBar();
                    lcd.setCursor(0,1); lcd.print("Desbloqueado");
                    delay(1000);
                    home();
                }
            }
